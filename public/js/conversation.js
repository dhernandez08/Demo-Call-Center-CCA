...
var Conversation = (function() {
  ...
  var txtConversation = "Conversación \n";
  ...
  function init() {
    ...
    initEnterSubmit();
    setupInputBox();
    console.log("inside init Conversation");
  }
  ...
  function buildMessageDomElement(newPayload, isUser) {
    ...
    var messageJson = {
      ...
      allConversationMsn(newPayload, isUser);
...
// saves the conversation history  to  send it 
  function allConversationMsn(newPayload, isUser){
    var dataObj = isUser ? newPayload.input : newPayload.output;
    var user =  isUser ? authorTypes.user : authorTypes.watson;
    if (dataObj.text != "inicio") {
    txtConversation =  txtConversation + "\n" + user + ":"  +  dataObj.text;
    console.log("VARIABLE: " + txtConversation  );
    }
